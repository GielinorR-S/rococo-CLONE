  ...
  <section class="emp-apply" aria-labelledby="apply-heading">
    <div class="narrow-wrap">
      ...
      <form action="#" method="POST" class="apply-form" novalidate>
        <div class="form-row"><label class="vh" for="app-name">Name</label><input id="app-name" name="name" type="text" placeholder="Name" required></div>
        <div class="form-row"><label class="vh" for="app-email">Email</label><input id="app-email" name="email" type="email" placeholder="Email" required></div>
        <div class="form-row"><label class="vh" for="app-role">Role Interest</label><input id="app-role" name="role" type="text" placeholder="Role Interest"></div>
        <div class="form-row full"><label class="vh" for="app-msg">Message</label><textarea id="app-msg" name="message" placeholder="Message" required></textarea></div>
